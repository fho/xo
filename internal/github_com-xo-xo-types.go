// Code generated by 'yaegi extract github.com/fho/xo/types'. DO NOT EDIT.

package internal

import (
	"github.com/fho/xo/types"
	"reflect"
)

func init() {
	Symbols["github.com/fho/xo/types/types"] = map[string]reflect.Value{
